    ...
    try {
      ...
      try {
        ...
        if (adminEmails.length > 0) {
          // Sequential execution via for...of loop prevents concurrent spam
...
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  <h2 style="color:#1e40af;">New Piece Access Request</h2>

  <p>
    A user has submitted a request to access a piece in Piecify.
  </p>
  ...
  <p>
    Please log in to Piecify to review this request and either approve or deny access.
  </p>

  <div style="margin-top:24px;">
    <a
      href="https://piecify.club"
      style="
        background:#2563eb;
        color:#ffffff;
        padding:12px 20px;
  ...
  <p style="font-size:12px;color:#6b7280;">
    This notification was automatically generated by Piecify when a user requested access to a piece.
  </p>
</div>
`,
            });

            // Increased to 400ms to guarantee you stay well under 5 requests/sec
